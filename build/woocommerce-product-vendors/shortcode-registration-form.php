...
<form class="wcpv-shortcode-registration-form">
	...
	<p class="form-row form-row-wide" style="display:none">
		...
		<textarea class="input-text" name="vendor_description" id="wcpv-vendor-description" rows="4" tabindex="7"><?php if ( ! empty( $_POST['vendor_description'] ) ) echo esc_textarea( $_POST['vendor_description'] ); ?>dd</textarea>
	</p>
